...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="row px-3 mt-5">
            <!-- product side -->
           <div class="col-md-3 text-center font-size"><a href=""><i class="fa-brands fa-square-facebook" aria-hidden="true"style="font-size:100px;color:pink"></i></a></div>
           <div class="col-md-3 text-center font-size"><a href=""><i class="fa-brands fa-telegram" aria-hidden="true"style="font-size:100px;color:pink"></i></a></div>
           <div class="col-md-3 text-center font-size"><a href=""><i class="fa-brands fa-square-instagram" aria-hidden="true"style="font-size:100px;color:pink"></i></a></div>
           <div class="col-md-3 text-center font-size"><a href=""><i class="fa fa-phone" aria-hidden="true"style="font-size:90px;color:pink"></i></a></div>
